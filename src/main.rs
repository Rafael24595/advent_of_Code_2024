...
fn main() {
    ...
    /* 10/12/2024 */
    try_execute_group(&exercises, "10", exercise_10::exercise_10_1, exercise_10::exercise_10_2);

    /* 11/12/2024 */
    try_execute_group(&exercises, "11", exercise_11::exercise_11_1, exercise_11::exercise_11_2);
